...
str_welcome      db  'Welcome to ', OS_NAME, '!', ASCII_CR, ASCII_LF, ASCII_NUL
str_bad_command  db  'Bad command entered.', ASCII_CR, ASCII_LF, ASCII_NUL
str_prompt       db  '>', ASCII_NUL
str_version      db  OS_NAME, ' ', OS_VER_MAJ, '.', OS_VER_MIN, '.', OS_VER_REV, ' (', OS_VER_DEV, ')', ASCII_CR, ASCII_LF, ASCII_NUL
